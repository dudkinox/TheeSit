...
function loadBundle(data) {
    return database6a3d9c64.loadBundle(this._delegate, data);
}
function namedQuery(queryName) {
    return database6a3d9c64.namedQuery(this._delegate, queryName).then(expQuery => {
        if (!expQuery) {
            return null;
        }
        return new database6a3d9c64.Query(this, 
...
registerBundle(database6a3d9c64.Firestore);
